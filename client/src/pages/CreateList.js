            ...
            <div className='card-body'>
              <form>
                ...
                <div className='form-group'>
                  ...
                  <textarea className='form-control' id='exampleFormControlTextarea1' rows='3' placeholder='Add a description to help people understand what your list/registry is for' value={description} onChange={e => setDescription(e.target.value)} />
                </div>
