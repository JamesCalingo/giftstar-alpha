        ...
        <div className="card">
          <form>
            <div className="form-group">
              ...
              <input value={this.state.user} onChange={this.handleInputChange} name="user" type="input" className="form-control form-control-lg" id="registryName" aria-describedby="userName" placeholder="" />
